    ...
    <div style={{ padding: 24, maxWidth: 700, margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gap: 16 }}>
        ...
        <div>
          ...
          <input type="file" accept="image/*" onChange={handleImageChange} style={{ padding: 12, borderRadius: 10, border: '1px solid #ccc', width: '100%' }} />
          {imagePreview && (
            <img src={imagePreview} alt="Preview" style={{ marginTop: 12, maxWidth: 200, maxHeight: 200, borderRadius: 10 }} />
          )}
        </div>

        <button type="submit" style={{ padding: '14px 18px', borderRadius: 12, border: 'none', backgroundColor: '#0288d1', color: '#fff', cursor: 'pointer' }}>
          Update Product
        </button>
      </form>
    </div>
